            ...
            <div class="col-md-12 mb-3">
              <table class="table">
                <tbody>
                  <tr>
                    <td colspan="2">
                      <h3 class="font-interitalic">Upload Data Store</h3>
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td>
                      <form class="uploadmaster" enctype="multipart/form-data">
                      <div class="d-flex row">
                        <div class="col-md-12 col-sm-6 mt-2">
                          <div class="mb-3">
                            <label for="formFileMultiple" class="form-label">Upload Data master csv Store</label>
                  ...
                  <tr>
                    <td colspan="2">
                      <h3 class="font-interitalic">Download Sampel Data Master Store</h3>
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td>
                      <div class="d-flex row">
                        <div class="col-md-6 col-sm-6 mt-2"><button onclick="window.location.href='<?= site_url('') ?>content/sampel/MASTERSTORE.xls'" class="btn btn-sm btn-warning mt-2 h-100 w-100 font-interreguler">Download sampel</button></div>
                      </div>
                    </td>
                  </tr>
                </tbody>
